          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                verticalSpacing(16),
                const GuidanceUserToHealHerCrop()
              ],
            ),
          ),
        )
...
class GuidanceUserToHealHerCrop extends StatefulWidget {
  const GuidanceUserToHealHerCrop({super.key});

  @override
  State<GuidanceUserToHealHerCrop> createState() =>
      _GuidanceUserToHealHerCropState();
}

class _GuidanceUserToHealHerCropState extends State<GuidanceUserToHealHerCrop> {
  @override
  Widget build(BuildContext context) {
    return Container(
